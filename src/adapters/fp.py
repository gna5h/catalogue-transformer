"""Fisher & Paykel dimension adapter.
...
# Matches "Height 820mm", "Width 597mm", "Depth 857 - 917mm" in page text
...
def _clean_value(raw: str) -> Optional[str]:
    """Normalise a dimension string to a unit-stripped or range-with-unit string."""
    raw = raw.strip()
    # Range: "857 - 917mm", "857-917mm", "857 – 917mm"
